...
const PREPARER_PHONE = "720-880-8084";
const PREPARER_EMAIL = "kyle@firestarterseo.com";
  ...
  return (
    <div className="cover">
      ...
      <div className="cover-grid">
        ...
        <div className="cover-cell"><label>Contact</label><span>{PREPARER_PHONE} &middot; {PREPARER_EMAIL}</span></div>
      </div>
